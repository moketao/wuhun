package  {
	 ...
	 */
	public class AnimationSequenceX extends Sprite {
		 ...
		 */
		public function AnimationSequenceX(textureAtlas:*, animations:Array, firstAnimation:String, animFps:Number = 30, firstAnimLoop:Boolean = false, smoothing:String = "bilinear") {
		 ...
		 * @return
		 */
		public static function fromMovieClip(swf:flash.display.MovieClip,firstAnim:String = null, animFps:int = 30, firstAnimLoop:Boolean = true, smoothing:String = "bilinear"):AnimationSequenceX
		{
			...
			return new AnimationSequenceX(textureAtlas, anims,(firstAnim in sorter)? firstAnim : anims[0], animFps, firstAnimLoop,smoothing);
		}
		 ...
		 */
		public function clone():AnimationSequenceX {
			return new AnimationSequenceX(_textureAtlas, _animations, _firstAnimation, _animFps, _firstAnimLoop, _smoothing);
		}
